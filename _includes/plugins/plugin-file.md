...
{% assign title = "Plugin File" %}
{% assign definition = site.data.plugins.plugin_file %}
...
Plugin files distributed with the system are stored in the corresponding folders on the following path: ```\Projects\[ProjectName]\Plugins\```.

To create a plugin and make it available to the system you need to:

1. Take a backup of the hierarchy.

2. Place it in the proper folder of the path.
